...
# Real launch cap, matching every other AI feature's per-user daily limit (Field-to-Finish, Tree
# Health, Impact Narrative) - see each module's own constant.
DAILY_READING_LIMIT = 2
